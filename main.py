...
try:
    # 🚀 修正ポイント: spreadsheet= を使わず、URLは第1引数、残りは**で渡す！
    conn = st.connection(URL, type=GSheetsConnection, **creds)
    df = conn.read(ttl=0)
